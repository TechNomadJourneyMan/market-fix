...
export const metadata: Metadata = { title: 'Добавить место' };
...
export default function NewVenuePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      <header>
        <h1 className="text-xl font-semibold tracking-tight">Добавить новое место</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Ресторан, кафе, бар, банкетный зал или любая площадка для бронирования. Карточка
          сразу появится в каталоге.
        </p>
      </header>
